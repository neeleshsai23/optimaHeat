...
@NgModule({
  declarations: [ClientsComponent, GridViewComponent, MapViewComponent, ProjectsDialogComponent, AddClientDialogComponent, GridColumnsJobsComponent],
  imports: [
    CommonModule,
  ...
  entryComponents:[AddClientDialogComponent,ProjectsDialogComponent,DeleteConfirmDialogComponent,GridColumnsJobsComponent]
})
